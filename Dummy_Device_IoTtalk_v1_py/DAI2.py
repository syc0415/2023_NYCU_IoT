...
DAN.profile['dm_name']='Syc_Dummy_087'   # you can change this but should also add the DM in server
DAN.profile['df_list']=['Color-I', 
                        'Slider', 
                        'Dmy_s087', 
                        'Dummy_Control']   # Check IoTtalk to see what IDF/ODF the DM has

DAN.profile['d_name']= "087_ODF1."+ str( random.randint(100,999 ) ) +"_"+ DAN.profile['dm_name'] # None
